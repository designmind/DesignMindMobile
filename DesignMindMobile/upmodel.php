...
<head>
    ...
    <title>UpModel Case Study | San Francisco Mobile Development Agency and Data Experts</title>
    <meta charset="utf-8" />
    <meta name="robots" content="noodp,noydir">

    <link rel="canonical" href="http://designmindmobile.com/upmodel.php" />
    ...
    <meta name="twitter:title" content="UpModel Case Study San Francisco App Development | Custom Mobile App Developers" />
  ...
  <body id="top" data-spy="scroll" data-target="#navbar">
    ...
    <section class="sawyer">
      <div class="container">
        <div class="row">
          <div class="col-sm-6">
            <img src="img/upmodel.jpg">
          </div>
          <div class="col-sm-6">
            <div class="row">
              <div class="col-sm-12">
                <div class="title">
                  <h1>Case Study:<br/>UpModel</h1>
                  <p>UpModel Renovations upgrades homes throughout the San Francisco Bay Area.  They needed an app for their employees to easily capture and send information to headquarters about clients and sales opportunities.</p>
                </div>
              </div>
            </div>
            <div class="row point">
              ...
              <div class="col-xs-8">
                <h2>Our Challenge</h2>
                <p>UpModel workers take measurements, and photos for each client, and plan the new project. With the app, they can send this data efficiently to headquarters.  Renovation experts receive the information, including designs and supplies needed.</p>
              </div>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-sm-6">
            <div class="row point">
              ...
              <div class="col-xs-8">
                <h2>Our Solution</h2>
                <p>Using our Mobile Accelerators, we created an app that provides up-to-the-minute data exchanges between field workers and headquarters. The app keeps track of jobs, supplies, revenues and length of projects. Customer estimates are faster and more accurate, and the sales cycle was shortened.</p>
              </div>
            </div>
            <div class="row point">
              <div class="col-xs-4">
              ...
              <div class="col-xs-8">
                <h2>The Results</h2>
                <p>Dashboards can give each regional manager a quick overview of his team’s projects and revenues.  Better communication yields faster decisions and better results.</p>
              </div>
            </div>
          ...
          <div class="col-sm-6 phone hidden-xs">
            <img src="img/upmodel_android.jpg">
          </div>
        </div>
      </div>
    </section>
    <section class="contact" id="contact">
      <div class="container">
        ...
        <form class="col-sm-8" role="form" method="post" action="upmodel.php">
          <div class="row">
