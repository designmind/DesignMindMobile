...
<head>
    ...
    <link rel="canonical" href="http://designmindmobile.com/mobile-workshop.php" />
  ...
  <body id="top" data-spy="scroll" data-target="#navbar" class="page-workshops">
    <!-- Navigation -->
    ...
    <section class="workshops" id="workshops">
      <div class="container">
        <div class="col-sm-6 col-sm-offset-6 content">
          ...
          <p>Schedule a 2-3 day workshop where we will gather requirements, define constraints, discuss objectives and develop the mobile opportunity. The first step is for our professionals to understand your business and the challenges you face.</p>
          <p>We’ll co-develop a plan and determine deliverables in only a few days.</p>
          <ul>
            <li>
              <h3>Day 1</h3>
              <p>Stakeholder strategy sessions at your office, requirements gathering, and needs identification.</p>
            </li>
            <li>
              <h3>Day 2</h3>
              <p>Small group design break-outs, security and technical constraints, and rapid prototyping.</p>
            </li>
            <li>
              <h3>Day 3</h3>
              <p>Our team creates a timeline, minimum viable product, and demos the user experience.  Wireframing begins.</p>
            </li>
          </ul>
          <p><a class="btn btn-default" href="#contact" role="button">Get started <i class="fa fa-chevron-right" aria-hidden="true"></i></a></p>
       </div>
     </div>
    </section>
